...
public class Lab6_Solution {
	...
	public Lab6_Solution(String input_file, Map<String, Integer> column_index) throws IOException {
        ...
        labe6_ns_str= "http://www.semanticweb.org/ernesto/inm713/lab6/";
        
        
        //Prefixes for the serialization
		model.setNsPrefix("lab6", labe6_ns_str);
	...
	public void Task3() throws JsonProcessingException, IOException, URISyntaxException {
        CovertCSVToRDF(false);
	}
        
    public void Task4() throws JsonProcessingException, IOException, URISyntaxException {
        CovertCSVToRDF(true);
    }
    ...
    protected void CovertCSVToRDF(boolean useExternalURI) throws JsonProcessingException, IOException, URISyntaxException {
        ...
        //within the code. E.g.,: labe6_ns_str + City
        ...
        mappingToCreateTypeTriple(column_index.get("country"), labe6_ns_str + "Country", useExternalURI);
            
        //We give subject and object columns (they could be the same), predicate and datatype 
        mappingToCreateLiteralTriple(column_index.get("country"), column_index.get("country"), labe6_ns_str + "name", XSDDatatype.XSDstring);
                
        mappingToCreateLiteralTriple(column_index.get("country"), column_index.get("iso2"), labe6_ns_str + "iso2code", XSDDatatype.XSDstring);
        
        mappingToCreateLiteralTriple(column_index.get("country"), column_index.get("iso3"), labe6_ns_str + "iso3code", XSDDatatype.XSDstring);
        

        
        //CITY TRIPLES
        //We give subject column and target type
        mappingToCreateTypeTriple(column_index.get("city_ascii"), labe6_ns_str + "City", useExternalURI);
        
        //We give subject and object columns (they could be the same), predicate and datatype 
        mappingToCreateLiteralTriple(column_index.get("city_ascii"), column_index.get("city_ascii"), labe6_ns_str + "name_ascii", XSDDatatype.XSDstring);

        
        mappingToCreateLiteralTriple(column_index.get("city_ascii"), column_index.get("city"), labe6_ns_str + "name", XSDDatatype.XSDstring);
        ...
        //mappingToCreateObjectTriple(column_index.get("city_ascii"), column_index.get("country"), labe6_ns_str + "cityIsLocatedIn");
    ...
    protected String createURIForEntity(String name, boolean useExternalURI) throws JsonProcessingException, IOException, URISyntaxException {
        ...
        stringToURI.put(name, labe6_ns_str + name.replaceAll(" ", "_"));
    ...
    protected void mappingToCreateCapitalTriple(int subject_column, int object_column, int capital_value_column) {
    	...
    	for (String[] row : csv_file) {
            ...
            String predicate = labe6_ns_str + "cityIsLocatedIn";
    		if (value.equals("admin"))
                predicate = labe6_ns_str + "isFirstLevelAdminCapitalOf";
    		else if (value.equals("primary"))
                predicate = labe6_ns_str + "isCapitalOf";
    		else if (value.equals("minor"))
				predicate = labe6_ns_str + "isSecondLevelAdminCapitalOf";
	...
	public static void main(String[] args) {
		...
		String file = "files_lab6/worldcities-free-100.csv";
