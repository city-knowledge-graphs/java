...
public class OWLReasoning {
	...
	public OWLReasoning(String file_input, String file_ouput) throws FileNotFoundException {
		...
		Reasoner reasoner = ReasonerRegistry.getOWLMiniReasoner();		//Approximate reasoner close to OWL 2 RL (but not exactly)
